...
import { ScrollView, Dimensions, View, StyleSheet, Image } from "react-native";
    ...
    return (
      ...
      >
        ...
        <SCLAlert
          ...
          theme="success"
          onRequestClose={() => {
            this.setState({ isModalUserName: false });
          }}
        ...
        <TouchableOpacity
          onPress={() => {
            this.setState({ isModalUserName: true });
          }}
        >
          <SettingsEditText title="Username" value={this.state.username} />
        </TouchableOpacity>

        <TouchableOpacity
          onPress={() => {
            this.setState({ isModalBirthday: true });
          }}
        >
          <SettingsEditText title="Birthday" value={this.state.birthday} />
        </TouchableOpacity>
        ...
        {this.state.isModalBirthday && (
          <DateTimePicker
            ...
            display="default"
            onChange={() => {
              this.setState({ isModalBirthday: false });
            }}
          />
        )}
        ...
        <TouchableOpacity
          onPress={() => {
            this.setState({ isModalPassword: true });
          }}
        >
          <SettingsEditText title="Password" value={this.state.password} />
        </TouchableOpacity>
        <SettingsButton title="Logout" onPress={() => alert("yeah win")} />
      </ScrollView>
    );
  }
}
