    ...
    return(
        <Modal style={{flex:1}} animationType="slide" visible={props.visible}>
          ...
          <Text style={styles.h3}>
              Nước là thành phần không thể tách rời với con người, nước giúp điều hòa cơ thể, tham
              gia vào các quá trình trao đổi chất, giúp hấp thu các chất dinh dưỡng tốt hơn
          </Text>
          </View>
          </View>
  ...
  return(
        <View style={{flexDirection:"column", alignItems:"center"}}>
            <View style={{flexDirection:"row"}}>
                ...
                <Text style={{marginLeft:5, color: Colors.black, fontSize:18,fontWeight: "bold"}}>Goal</Text>
            </View>

            <Text style={{width:340, alignContent:"center", alignSelf:"center"}}>Thử thách bạn sẽ là uống nước với bạn bè mỗi buổi sáng, chiều tối mỗi ngày 250ml trong 7 ngày</Text>
        </View>
  );
}
